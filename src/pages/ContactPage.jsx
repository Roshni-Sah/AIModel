    ...
    <div className="contact-page-container">
      ...
      <main className="page-shell">
        <header className="contact-hero">
          <span className="eyebrow"><i className="fas fa-paper-plane" aria-hidden="true" /> Contact Dhruv.AI</span>
        ...
        <section className="contact-grid" aria-label="Contact form and contact details">
            ...
            <form id="contactForm" onSubmit={handleSubmit}>
              <div className="form-grid">
                ...
                <div className="field full">
                  ...
                  <textarea id="message" name="message" placeholder="Tell us about your farm size, crop type, pilot idea, or the problem you want solved..." />
                </div>
              </div>
          ...
          <aside className="info-panel">
            ...
            <p className="section-copy">For partnerships, pilots, demos, incubation conversations, or media inquiries.</p>
            <div className="quick-stack">
              ...
              <div className="quick-card">
                ...
                <p>Crop disease detection, precision spraying, drone demos, pilots, startup collaborations, and smart agriculture deployment.</p>
              </div>
              <div className="quick-card">
                <h3>Social</h3>
